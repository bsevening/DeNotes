<cfoutput>
	<div id="login" class="shadow round-corners">
		...
		<form id="loginForm" name="loginForm" method="POST">
			...
			<span id="forgotpasswordlink" class="loginlink">forgot password?</span>
			<span id="newuserlink" class="loginlink">new user?</span>
		</form>
		<div id="newuserdialog" title="New User"></div>
		<div id="forgotpassworddialog" title="Forgot Password"></div>
	</div>
